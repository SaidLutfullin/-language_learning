...
from .views import (Dictionary, AddingWord, EditWord, Exporting, WordOperations,
                    GetSuccessPage, TestView)
...
urlpatterns = [
    ...
    path('api/v1/word_operations', WordOperations.as_view(), name='word_operations_api'),
    path('api/v1/get_success_page', GetSuccessPage.as_view(), name='get_success_page_api'),
]
