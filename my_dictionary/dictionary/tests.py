...
class TestCorrector(TestCase):
    ...
    def test_check_answer(self):
        ...
        self.assertEqual(self.corrector.check_answer('ass*ssin', 'assassin',
                                                     ...
                                                     'ass<a>ssin')
        # typo in the start
        self.assertEqual(self.corrector.check_answer('*ssassin',
                                                     'assassin', '<', '>'),
                                                     '<a>ssassin')
        # typo in the end
        ...
        self.assertEqual(self.corrector.check_answer('qwertyyy', 'qwertyy',
                                                     ...
                                                     'qwert<yy>')
        # similar
        self.assertEqual(self.corrector.check_answer('qwerty', 'qwerty',
                                                     '<', '>'), 1)
        # two mistakes
        self.assertEqual(self.corrector.check_answer('qw*rt*', 'qwerty',
                                                     '<', '>'), 0)
