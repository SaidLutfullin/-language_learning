    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(max_length=1000, verbose_name='Текст (максимальная длина комментария 1000 символов)')),
                ('created', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Оставлен')),
